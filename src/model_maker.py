...
#nodes = np.load('/home/master/Desktop/GIT/node2vec-final/node2vec/src/nodes.npy')
def word2id(word):
	
	for node in nodes:
		if node[1]["label"] == word:
			return str(node[0])
...
if __name__ == "__main__":
	...
	#w1 = "you"
	#w2 = "yourself"
	#print(model.wv.similarity(word2id(w1), word2id(w2)))
	#print(model.wv.similarity("1", "3"))
